...
class UsersTest(unittest.TestCase):
  ...
  def test_user_login_with_an_invalid_email(self):
  ...
  def test_user_get_me(self):
    ...
    json_data = json.loads(res.data)
    self.assertEqual(res.status_code, 200)
    self.assertEqual(json_data.get('email'), 'emanuel@muf.com')
    self.assertEqual(json_data.get('name'), 'emanuel')
  ...
  def test_user_update_me(self):
    ...
    json_data = json.loads(res.data)
    self.assertEqual(res.status_code, 200)
    self.assertEqual(json_data.get('name'), 'new_name')
